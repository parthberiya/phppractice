<?php   
    ...
    $sql = "UPDATE contact_form SET name='$name', phone_number='$phone_number', email='$email', address='$address', profile_image='$imagelist' WHERE id=$id";
...
<body>
    <div class="main-div">
        <div class="container">
            ...
            ?>
            <h2>Update Form</h2>
            <form id="update-form" method="post" action="update.php" enctype="multipart/form-data" >
                <ul>      
                    <li>
